...
Bootstrap replicates of a network for each genus can be computed by creating a set of networks from a set of ramdom samples of gene trees and the same species tree.
