...
%Title
\title{\Huge Is Sharing Caring?}
\subtitle{Effects of the Presence of CRISPR-Cas Systems on Rates of Horizontal Gene Transfer Using Network Analysis}
\date{\today}
...
\begin{frame}[fragile]{Network Statistics}
    \begin{itemize}
        \item<2-> \textbf{Average Node Degree}: $\sum_i w_i$,$\frac{\sum_i w_i}{N}$
