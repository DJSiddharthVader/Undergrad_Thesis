...
\begin{frame}[fragile]{CRISPR Cost Complexity and Curbing It}
    ...
    \begin{column}{0.5\textwidth} %Costs
        ...
        \begin{itemize}
            \item<3-> Metabolic maintenance \autocite{crispgen}
            \item<6-> Off-target effects (autoimmune) \autocite{selfcrisp}
            \item<7-> Anti-CRISPR systems \autocite{acqorres}
        \end{itemize}
        \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth} %Curbing it
    \begin{itemize}
        \item<4-> Cost Reduction Strategies
        \begin{itemize}
            \item<5-> Selective CRISPR inactivation \autocite{crispgen}
            \item<8-> CRISPRs themselves can be transferred $\implies$ population level immunity \autocite{crisprlgt}
        \end{itemize}
    \end{itemize}
    \end{column}
    \end{columns}
